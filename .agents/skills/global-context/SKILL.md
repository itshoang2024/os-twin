...
knowledge_query("<project-namespace>", "authentication flow", mode="summarized")
```
...
knowledge_query("<project-namespace>", "rate limiting implementation", mode="summarized")
```
...
3. **Query detailed knowledge:**
   ```
   knowledge_query("<project-namespace>", "[feature keyword]", mode="summarized", top_k=10)
   ```
